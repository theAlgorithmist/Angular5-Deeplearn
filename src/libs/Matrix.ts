...
{
  protected _n: number = 0;                   // column count
  ...
  public sumRows(): Array<number>
  {
    ...
    let sum: Array<number> = new Array<number>();
   ...
   */
  public addTo(matrix: TSMT$Matrix): TSMT$Matrix
  {
    if (!matrix || matrix.m != this._matrix.length || matrix.n != this._n) {
      return null;
    }
   ...
   */
  public subtractFrom(matrix: TSMT$Matrix): TSMT$Matrix
  {
